...
namespace CST.Registrar
{
    public partial class reqattachment : Form
    {
        ...
        {
            string path = CreateDirectory.CreateDir(ApplicationNationalIDModel.getSno() + "-" + ApplicationNationalIDModel.getSn());
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            frm.Show();
            ApplicationNationalIDModel.clearAll();
            this.Close();
        }
        ...
        private async Task saveDb(int reqid, string filename, string path)
        {
            ...
            listparams.Add(new MySqlParameter("@sno", ApplicationNationalIDModel.getSno()));
